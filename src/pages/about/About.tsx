...
const items = [
  {
    ...
    content: 'The Company offers armed and unarmed security officers, patrol, intrusion alarm response, investigations, electronic security equipment, closed circuit television, security cameras, and training. We always treat everything seriosly. We always strictly follow SOP and security best practices.',
  },
  {
    key: '2',
    ...
    content: 'Our security personel are well trained and certified professional. They are trained to handle simple to complex security issues. We are well organize and disciplined company.',
  },
  {
    key: '3',
    ...
    content: 'The company loves continues improvement. We are collabrative and we think out of the box. We are ulways updated in new security protocol and security technology that will help us to serve you best.',
  },
]
